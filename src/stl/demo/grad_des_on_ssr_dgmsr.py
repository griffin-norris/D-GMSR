def grad_des_on_ssr_dgmsr():
    ...
    if save_fig: fig.savefig('figs/dssr.' + fig_format, bbox_inches='tight', dpi=fig_png_dpi)
    ...
    if save_fig: fig.savefig('figs/dgmsr.' + fig_format, bbox_inches='tight', dpi=fig_png_dpi)
