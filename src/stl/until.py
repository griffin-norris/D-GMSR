...
def verify_UNTIL_grads(ITE: int):
    ...
    for i in range(ITE):
        ...
        pos_neg_1 = [0.0, 0.0, -0.5, -0.5]
        pos_neg_2 = [0.0, -0.5, 0.0, -0.5]
        ...
        for case in range(4):
            ...
            # Analitic Gradients
            phi_12_k, phi_1_grad, phi_2_grad = UNTIL(
                eps, p, w_phi_1, w_phi_2, w_phi_12, phi_1, phi_2
            )
            ...
            for idx in range(2 * K):
                ...
                phi_12_k1, _, _ = UNTIL(
                    eps, p, w_phi_1, w_phi_2, w_phi_12, x_back[:K], x_back[K:]
                )
                phi_12_k2, _, _ = UNTIL(
                    eps, p, w_phi_1, w_phi_2, w_phi_12, x_next[:K], x_next[K:]
                )
